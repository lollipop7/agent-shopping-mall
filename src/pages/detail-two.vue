...
<template>
  <div class="detail mall-wrap">
    <div class="container">
      <p class="site-cont"><b style="font-size: 18px">家具器具</b>>器具>HUROM/惠人原汁机HUO16SG/FR 韩国原装家用榨汁机惠仁低速果汁机</p>
        <div class="productDetails">
            <img src="/static/images/detail/goods_6.png" width="440" height="440"/>
            <div class="productDetailInfo">
                <h2>
                    <img src="/static/images/detail/fubao.png"/>
                    HUROM/惠人原汁机HUO16SG/FR 韩国原装家用榨汁机惠仁低速果汁机
                </h2>
                <div class="price">
                    <span class="marketPrice">参&nbsp;&nbsp;考&nbsp;&nbsp;价：<s>￥5900.10</s></span><br/>
                    <span class="lovePrice">京&nbsp;&nbsp;东&nbsp;&nbsp;价：<span><b>￥2598.00</b></span></span>
    ...
    <div class="containerProductDetail">
        <div class="detailLeft">
            ...
            <div class="detailLeftBottom">
                ...
                <div class="title">
                    <img src="/static/images/detail/goods_2.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
                <div class="title">
                    <img src="/static/images/detail/goods_3.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
                <div class="title">
                    <img src="/static/images/detail/goods_4.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
            </div>
        ...
        <div class="detailRight">
            ...
            <img src="/static/images/detail/goods_7.png" width="100%"/>
        </div>
    </div>
  </div>
</template>
