...
<template>
  <div class="detail mall-wrap">
    <div class="container">
      <p class="site-cont"><b style="font-size: 18px">个护美妆</b>>美妆>韩后植物能量粉底液bb霜防水裸妆强遮瑕白皙保湿控油提亮肤色</p>
        <div class="productDetails">
            <img src="/static/images/detail/goods_11.png" width="440" height="440"/>
            <div class="productDetailInfo">
                <h2>
                    <img src="/static/images/detail/fubao.png"/>
                    韩后植物能量粉底液bb霜防水裸妆强遮瑕白皙保湿控油提亮肤色
                </h2>
                <div class="price">
                    <span class="marketPrice">参&nbsp;&nbsp;考&nbsp;&nbsp;价：<s>￥68.10</s></span><br/>
                    <span class="lovePrice">京&nbsp;&nbsp;东&nbsp;&nbsp;价：<span><b>￥43.00</b></span></span>
    ...
    <div class="containerProductDetail">
        <div class="detailLeft">
            ...
            <div class="detailLeftBottom">
                ...
                <div class="title">
                    <img src="/static/images/detail/goods_12.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
                <div class="title">
                    <img src="/static/images/detail/goods_13.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
                <div class="title">
                    <img src="/static/images/detail/goods_14.png" width="150" height="150"/>
                    <p>不畏将来,不念过去——《我的前半生》演员张龄心 诚意推荐</p>
                    <p style="color: #e60012; font-weight: bold; line-height: 35px">￥32.80</p>
                </div>
            </div>
        ...
        <div class="detailRight">
            ...
            <img src="/static/images/detail/goods_15.png" width="100%"/>
        </div>
    </div>
  </div>
</template>
